...
df5=pd.read_csv('csv/Cold_Inv_TimeSeries.csv')
fig, ax = plot.subplots()
ax.set_ylim(0,90)
ws=df5['Solar_Rad'].groupby(df5['Hours from Start'])
ax.plot(ws.mean(['Solar_Rad']))
plot.title("HBEF SCAN site Solar Radiation")
plot.xlabel("hour")
plot.ylabel("solar radiation (W/m^2)")
plot.show()
