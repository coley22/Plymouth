...
for i in [850]:
    ...
    hgt_subset2d0 = np.reshape(hgt_subset0, (t + 1, x*y))  # Reshape array to 2D: Rows=date, Columns=gridpoint
    ...
    hgt_subset2d4 = np.reshape(hgt_subset4, (t + 1, x*y))  # t+1 is for leap years
